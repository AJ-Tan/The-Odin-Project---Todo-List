...
const EditProject = () => {
  ...
  modalTitleNode.textContent = "Edit Project";
  ...
  priorityOptions[todoData.currentProject.projectPriority].selected = true;
  ...
  modalFormNode.addEventListener("submit", e => {
    ...
    todoData.updateProject(todoData.currentProject, projectData);
